...
pdf_path = "/Users/chiahua/.gemini/antigravity/brain/147558ff-4d95-470c-a7ba-1c1ac3d99437/.user_uploaded/media_1787932504697.pdf"
    ...
    for page in pdf.pages:
        ...
        for table in tables:
            for row in table:
                ...
                theme_val = clean_row[0]
                sub_theme_val = clean_row[1]
                col_item = clean_row[2]
                col_strategy = clean_row[3]
